## Seed code - Boilerplate for step 5 NoteService - KeepNote Assignment

### Problem Statement

In this case study KeepNote Step 5 -  NoteService, We will write main class for spring boot Application, model class, repository class, service class and interface, logging aspect.
